...
export class EmployeeCalculate extends Component {
  ...
  handleSubmit(e){
      ...
      if (this.state.absentDays === '' || this.state.workedDays === '') {
...
<button type="button" onClick={() => this.props.history.push("/employees/index")} className="btn btn-primary">Back</button>
  ...
  async calculateSalary() {
    ...
    //Added this helper function to format numbers
    //Example: 16619.91 -> 16,619.91, 7550 -> 7,550.00
    ...
    this.setState({ loadingCalculate: false, netIncome: formatNumber(data) });
  }
